...
if(isset($_POST['confirm']))
{
    ...
    $mail->Body = '<p align=center>Name:'.$_POST['username'].'<br>Email:'.$_POST['email'].'<br>CountryCode:'.$_POST['countryCode']
                .'<br>Telephone:'.$_POST['tel'].'<br>Amount:'.$_POST['amount'].'</p>';  
    $mail->addAddress('awontiromanus10@gmail.com');
    if(!$mail->send())
     {
      $result = "Error Occured <br> Please Check your details";
            
    }else{
        $result = "Thanks ".$_POST['username']." <br>We'll Call you and Explain how you'll send the money!";
    }
}  
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <title>support</title>
        <style>
            .links{float: right; border-radius: 3px; border: 1px solid #000; padding:0px; margin-right: 20%;}
            .links ul li{display: inline-block; margin-left:  20px;}
            .links  ul li a{color: #333; text-decoration: none;  font-family: "Roboto", sans-serif; font-size: 15px;} 
        </style>
         <script>
    ...
    <div class="container">
        ...
        <header>
           ...
           <div class="main-form" style="background:url('resources/pics/c.jpg')">
               <div class="donation" style="border-radius:5px; border:1px solid #000; margin-top: 50px; background:url('resources/pics/c.jpg')">
                   <span style="margin-left: 5%; border-radius:5px; border:1px solid #000;  background-color: cornsilk">
                       <strong>Notice:</strong>
                       Our Donation system is to be banked wired because we don't yet have the
                       capability to establish an online transaction system</span>
                   
                   <form style="" id="pay" method="post" action="" enctype="multipart/form-data">
                     <div style="width: 400px; border-radius:5px; border:0.5px solid #f2f2f2; margin-left:15px; color:forestgreen">
                            <?= $result; ?>
                            </div>
                       
                       <input type="text" name="username" placeholder="FULL NAMES" required/>
                    ...
                    <option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
                       ...
                       </select><input type="tel" name="tel" placeholder="TELEPHONE" required />
                       
                       <input type="text" name="amount" placeholder="AMOUNT e.g 1000FCFA, 100$ etc" />
                       <input type="submit" class="btn-primary btn" name="confirm" value="PROCEED" />
                   </form>
               </div>
           </div>
