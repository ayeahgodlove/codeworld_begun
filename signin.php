    ...
    <div class="container">
        ...
        <header>
            ...
            <div class="topnav" id="myTopnav" style="margin-left:40%; padding-top: 30px; ">
                ...
                <h1  style="text-align: center; color: #000; background:url('resources/pics/c.jpg')">LOGIN</h1>
           <!-- Main -->

           <div class="main-form" style=" background:url('resources/pics/c.jpg')" >
                <div style="border-radius:5px; border: 1px solid cornsilk; background-color: cornsilk; text-align:center">
                    Attention!!!
                    This is meant for Website's Admin
                    
                </div>
                 <div style="border-radius:10px; border: 1px solid #000; margin-top: 50px; background:url('resources/pics/c.jpg')">   
                     <p style="text-align: center; color: red;"> <?php //include('controllers/errors.php'); ?></p>
                     <form action="admin/loginCode.php" method="post" enctype="multipart/form-data">
                         <input style="" type="text" name="username" placeholder="USERNAME" required/>
                         <input style="" type="email" name="email" placeholder="EMAIL" required />
                         <input type="password" name="password" placeholder="PASSWORD" required/>
                        <input class="btn-primary btn" type="submit" name="login" value="LOGIN" />
                    </form>
