...
if(isset($_POST['send']))
{
    ...
    $mail->Body = '<p align=center>Name:'.$_POST['username'].'</p><p>Email:'.$_POST['email'].'</p><p>Location:<br>'.$_POST['location']
                .'</p><p>Message:<br>'.$_POST['message'].'</p>';  
    $mail->addAddress('awontiromanus10@gmail.com');
    if(!$mail->send())
     {
      $result = "We're so sorry something went wrong. <br> Please try again!";
            
    }else{
        $result = "Thanks ".$_POST['username']." for contacting us <br> We'll get back to you soon!";
    }
}  
?>
<!DOCTYPE html>
    ...
    <div class="container">
        ...
        <header>
            ...
            <div class="main-form" style="background:url('resources/pics/c.jpg')" >
                ...
                <div class="contain" style="background:url('resources/pics/c.jpg')">
                    <div style="padding-left:20%;"><?= $result; ?></div>
                    <form id="login" action="contact.php" method="post" enctype="multipart/form-data">
                        <input type="text" name="username" placeholder="Full Names" required/><br>
                        ...
                        <textarea name="message" >Write your message Here
                        </textarea>
                        <input class="btn-primary btn" type="submit" name="send" value="SEND YOUR MESSAGE" />
                    </form>
               
                </div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m26!1m12!1m3!1d63677.47940527283!2d9.6489746964814!3d4.052534495551637!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!4m11!3e6!4m3!3m2!1d4.0804228!2d9.650597099999999!4m5!1s0x10616d53ec0c0d4f%3A0x48681fde9cc16fa6!2sA%C3%A9roport+international+de+Douala!3m2!1d4.0134386!2d9.717007299999999!5e0!3m2!1sen!2scm!4v1542901387717"  height="300" frameborder="0" style="border:0; width: 80%; margin-left: 10%;" allowfullscreen></iframe>
               
                <div class="clearfix"></div>
                <div class="responsive" style="color:#000; background-color: cornsilk; width:100%">
                    <div class="gallery">
                        <div class="desc" >
                            <h5>HEADQUATERS</h5>
